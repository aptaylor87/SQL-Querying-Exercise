...
SELECT app_name FROM analytics WHERE price BETWEEN .03 AND 1 ORDER BY rating DESC LIMIT 10;
...
SELECT app_name, reviews, min_installs, min_installs / reviews AS proportion FROM analytics WHERE min_install
s >= 100000 ORDER BY proportion DESC LIMIT 1;
